<template>
  <my-app>
    ...
    <v-footer app>
      <div class="text-center font-weight-light text-caption" style="width: 100%;">
        <span class="mr-1">&copy; 2023</span>
        <span class="mr-1">|</span>
        <span class="mr-1">Made with <v-icon color="red">mdi-heart</v-icon> by <a
