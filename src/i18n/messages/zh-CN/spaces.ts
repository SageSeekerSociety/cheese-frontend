export default {
  detail: {
    ...
    noAdmins: '暂无管理员',
    creator: '创建者 {creator}',
    creatorAndAdmins: '创建者 {creator} 和 {count} 位管理员',
    ...
    publishSuccess: '发布成功',
    publishFailed: '发布失败',
    noPermission: '您没有权限发布公告',
    auditTasks: {
      title: '审核赛题',
      noTasks: '暂无赛题',
      publishedAt: '{publisher} 发布于 {time}',
      deadline: '截止时间',
      teamContest: '团队赛题',
      individualContest: '个人赛题',
      resubmittable: '可多次提交',
      editableSubmission: '允许编辑提交',
      detailedInfo: '详细信息',
      description: '赛题描述',
      submissionRequirements: '提交要求',
      noRequirements: '无提交要求',
      approve: '通过',
      reject: '驳回',
    ...
    selectTemplate: {
      title: '选择赛题模板',
      back: '返回',
      blankTemplate: '从空白赛题开始',
    },
    tasks: {
      searchPlaceholder: '在当前空间中搜索',
      sort: '排序',
      sortOptions: {
      ...
      publishTask: '发布赛题',
      noTasks: '暂无赛题',
      getSpaceDetailsFailed: '获取空间详情失败:',
    },
    templateForm: {
      editTitle: '编辑赛题模板',
      createTitle: '创建赛题模板',
