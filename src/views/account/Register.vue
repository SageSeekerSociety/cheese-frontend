  ...
  <v-card class="mx-auto" max-width="600" width="100%">
    ...
    <v-card-text>
      <v-form>
        ...
        <v-text-field label="密码" placeholder="请输入密码" prepend-inner-icon="mdi-lock" type="password" />
        <v-text-field label="确认密码" placeholder="请再次输入密码" prepend-inner-icon="mdi-lock" type="password" />
        <v-text-field label="邮箱" placeholder="请输入邮箱" prepend-inner-icon="mdi-email" type="email" />
